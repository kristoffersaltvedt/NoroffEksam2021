...
#include "Quaternions_Rotation.h"

// Formula to convert a Euler angle in degrees to a quaternion rotation
FQuat UQuaternions_Rotation::Euler_To_Quaternion(FRotator Current_Rotation)
{
...
void UQuaternions_Rotation::SetWorldRotationQuat(USceneComponent* SceneComponent, const FQuat& Desired_Rotation)
{
    if (SceneComponent)
    {
...
void UQuaternions_Rotation::SetRelativeRotationQuat(USceneComponent* SceneComponent, const FQuat& Desired_Rotation)
{
    if (SceneComponent)
    {
...
void UQuaternions_Rotation::AddLocalRotationQuat(USceneComponent* SceneComponent, const FQuat& Delta_Rotation)
{
    if (SceneComponent)
    {
...
void UQuaternions_Rotation::SetActorWorldRotationQuat(AActor* Actor, const FQuat& Desired_Rotation)
{
    if (Actor)
    {
...
void UQuaternions_Rotation::SetActorRelativeRotationQuat(AActor* Actor, const FQuat& Desired_Rotation)
{
    if (Actor)
    {
...
void UQuaternions_Rotation::AddActorLocalRotationQuat(AActor* Actor, const FQuat& Delta_Rotation)
{
    if (Actor)
    {
