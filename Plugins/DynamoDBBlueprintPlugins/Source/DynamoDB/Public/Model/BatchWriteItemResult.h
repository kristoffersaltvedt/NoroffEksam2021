    ...
    FBatchWriteItemResult &fromAWS(const Aws::DynamoDB::Model::BatchWriteItemResult &awsBatchWriteItemResult) {
        {
            ...
            for (const std::pair<Aws::String, Aws::Vector<Aws::DynamoDB::Model::WriteRequest>>& elem : awsBatchWriteItemResult.GetUnprocessedItems()) {
        ...
        {
            Aws::Utils::Json::JsonValue jsonValue;
            for (const std::pair<Aws::String, Aws::Vector<Aws::DynamoDB::Model::ItemCollectionMetrics>>& elem : awsBatchWriteItemResult.GetItemCollectionMetrics()) {
                Aws::Utils::Array<Aws::Utils::Json::JsonValue> jsonArray1(elem.second.size());
                int i = 0;
