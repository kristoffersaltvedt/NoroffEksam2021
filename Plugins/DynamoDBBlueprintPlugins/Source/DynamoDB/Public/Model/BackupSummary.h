...
GENERATED_BODY()
    ...
    **/
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "DynamoDB Client")
    EAWSBackupType backupType;

    /**
    *  <p>Size of the backup in bytes.</p>
    **/
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "DynamoDB Client")
    int64 backupSizeBytes;
...
public:
    FBackupSummary &fromAWS(const Aws::DynamoDB::Model::BackupSummary &awsBackupSummary) {
        ...
        this->backupCreationDateTime = FDateTime::FromUnixTimestamp(awsBackupSummary.GetBackupCreationDateTime().Millis());

        this->backupExpiryDateTime = FDateTime::FromUnixTimestamp(awsBackupSummary.GetBackupExpiryDateTime().Millis());
