...
#include "ExpectedAttributeValue.generated.h"
...
#if WITH_DYNAMODBCLIENTSDK && WITH_CORE
public:
    Aws::DynamoDB::Model::ExpectedAttributeValue toAWS() const {
        Aws::DynamoDB::Model::ExpectedAttributeValue awsExpectedAttributeValue;

        if (!(this->value.IsEmpty())) {
            awsExpectedAttributeValue.SetValue(this->value.toAWS());
        }

        awsExpectedAttributeValue.SetExists(this->exists);

        switch(this->comparisonOperator) {
            case EAWSComparisonOperator::EQ:
                awsExpectedAttributeValue.SetComparisonOperator(Aws::DynamoDB::Model::ComparisonOperator::EQ);
                break;
            case EAWSComparisonOperator::NE:
                awsExpectedAttributeValue.SetComparisonOperator(Aws::DynamoDB::Model::ComparisonOperator::NE);
                break;
            case EAWSComparisonOperator::IN_:
                awsExpectedAttributeValue.SetComparisonOperator(Aws::DynamoDB::Model::ComparisonOperator::IN_);
                break;
            case EAWSComparisonOperator::LE:
                awsExpectedAttributeValue.SetComparisonOperator(Aws::DynamoDB::Model::ComparisonOperator::LE);
                break;
            case EAWSComparisonOperator::LT:
                awsExpectedAttributeValue.SetComparisonOperator(Aws::DynamoDB::Model::ComparisonOperator::LT);
                break;
            case EAWSComparisonOperator::GE:
                awsExpectedAttributeValue.SetComparisonOperator(Aws::DynamoDB::Model::ComparisonOperator::GE);
                break;
            case EAWSComparisonOperator::GT:
                awsExpectedAttributeValue.SetComparisonOperator(Aws::DynamoDB::Model::ComparisonOperator::GT);
                break;
            case EAWSComparisonOperator::BETWEEN:
                awsExpectedAttributeValue.SetComparisonOperator(Aws::DynamoDB::Model::ComparisonOperator::BETWEEN);
                break;
            case EAWSComparisonOperator::NOT_NULL:
                awsExpectedAttributeValue.SetComparisonOperator(Aws::DynamoDB::Model::ComparisonOperator::NOT_NULL);
                break;
            case EAWSComparisonOperator::NULL_:
                awsExpectedAttributeValue.SetComparisonOperator(Aws::DynamoDB::Model::ComparisonOperator::NULL_);
                break;
            case EAWSComparisonOperator::CONTAINS:
                awsExpectedAttributeValue.SetComparisonOperator(Aws::DynamoDB::Model::ComparisonOperator::CONTAINS);
                break;
            case EAWSComparisonOperator::NOT_CONTAINS:
                awsExpectedAttributeValue.SetComparisonOperator(Aws::DynamoDB::Model::ComparisonOperator::NOT_CONTAINS);
                break;
            case EAWSComparisonOperator::BEGINS_WITH:
                awsExpectedAttributeValue.SetComparisonOperator(Aws::DynamoDB::Model::ComparisonOperator::BEGINS_WITH);
                break;
            default:
                break;
            }
        ...
        for (const FDynamoDBAttributeValue& elem : this->attributeValueList) {
            awsExpectedAttributeValue.AddAttributeValueList(elem.toAWS());
        }

        return awsExpectedAttributeValue;
    }

    bool IsEmpty() const {
        return this->value.IsEmpty() && false && this->comparisonOperator == EAWSComparisonOperator::NOT_SET && this->attributeValueList.Num() == 0;
    }
#endif
};
