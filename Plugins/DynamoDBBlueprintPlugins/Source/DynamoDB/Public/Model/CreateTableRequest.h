...
public:
    ...
    bool IsEmpty() const {
        return this->attributeDefinitions.Num() == 0 && this->tableName.IsEmpty() && this->keySchema.Num() == 0 && this->localSecondaryIndexes.Num() == 0 && this->globalSecondaryIndexes.Num() == 0 && this->billingMode == EAWSBillingMode::NOT_SET && this->provisionedThroughput.IsEmpty() && this->streamSpecification.IsEmpty() && this->sSESpecification.IsEmpty() && this->tags.Num() == 0;
    }
#endif
};
