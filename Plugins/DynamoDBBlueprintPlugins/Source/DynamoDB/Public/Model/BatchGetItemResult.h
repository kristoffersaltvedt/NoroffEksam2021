    ...
    FBatchGetItemResult &fromAWS(const Aws::DynamoDB::Model::BatchGetItemResult &awsBatchGetItemResult) {
        {
            ...
            for (const std::pair<Aws::String, Aws::Vector<Aws::Map<Aws::String, Aws::DynamoDB::Model::AttributeValue>>>& elem : awsBatchGetItemResult.GetResponses()) {
                ...
                for (const Aws::Map<Aws::String, Aws::DynamoDB::Model::AttributeValue>& elem1 : elem.second) {
                    ...
                    for (const std::pair<Aws::String, Aws::DynamoDB::Model::AttributeValue>& elem2 : elem1) {
        ...
        for (const std::pair<Aws::String, Aws::DynamoDB::Model::KeysAndAttributes>& elem : awsBatchGetItemResult.GetUnprocessedKeys()) {
