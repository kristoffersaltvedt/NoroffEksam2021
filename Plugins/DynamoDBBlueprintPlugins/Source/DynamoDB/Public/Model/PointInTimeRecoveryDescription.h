...
GENERATED_BODY()
    ...
    **/
    ...
    EAWSPointInTimeRecoveryStatus pointInTimeRecoveryStatus;
...
public:
    FPointInTimeRecoveryDescription &fromAWS(const Aws::DynamoDB::Model::PointInTimeRecoveryDescription &awsPointInTimeRecoveryDescription) {
        ...
        this->earliestRestorableDateTime = FDateTime::FromUnixTimestamp(awsPointInTimeRecoveryDescription.GetEarliestRestorableDateTime().Millis());

        this->latestRestorableDateTime = FDateTime::FromUnixTimestamp(awsPointInTimeRecoveryDescription.GetLatestRestorableDateTime().Millis());
