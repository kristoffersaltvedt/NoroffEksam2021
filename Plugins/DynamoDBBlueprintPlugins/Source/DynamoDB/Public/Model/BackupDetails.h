...
public:
    FBackupDetails &fromAWS(const Aws::DynamoDB::Model::BackupDetails &awsBackupDetails) {
        ...
        this->backupCreationDateTime = FDateTime::FromUnixTimestamp(awsBackupDetails.GetBackupCreationDateTime().Millis());

        this->backupExpiryDateTime = FDateTime::FromUnixTimestamp(awsBackupDetails.GetBackupExpiryDateTime().Millis());
