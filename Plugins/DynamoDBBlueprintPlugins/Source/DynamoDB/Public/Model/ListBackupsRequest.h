...
GENERATED_BODY()
    ...
    **/
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "DynamoDB Client")
    EAWSBackupTypeFilter backupType;
...
public:
    Aws::DynamoDB::Model::ListBackupsRequest toAWS() const {
        ...
        awsListBackupsRequest.SetTimeRangeLowerBound(Aws::Utils::DateTime((int64_t)this->timeRangeLowerBound.ToUnixTimestamp()));

        awsListBackupsRequest.SetTimeRangeUpperBound(Aws::Utils::DateTime((int64_t)this->timeRangeUpperBound.ToUnixTimestamp()));
