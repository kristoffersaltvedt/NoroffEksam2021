...
#include "Quaternion_Tilting.h"

// Formula to convert a Euler angle in degrees to a quaternion rotation
FQuat UQuaternion_Tilting::Euler_To_Quaternion(FRotator Current_Rotation)
{
...
void UQuaternion_Tilting::SetWorldRotationQuat(USceneComponent* SceneComponent, const FQuat& Desired_Rotation)
{
	if (SceneComponent)
	{
...
void UQuaternion_Tilting::SetRelativeRotationQuat(USceneComponent* SceneComponent, const FQuat& Desired_Rotation)
{
	if (SceneComponent)
	{
...
void UQuaternion_Tilting::AddLocalRotationQuat(USceneComponent* SceneComponent, const FQuat& Delta_Rotation)
{
	if (SceneComponent)
	{
...
void UQuaternion_Tilting::SetActorWorldRotationQuat(AActor* Actor, const FQuat& Desired_Rotation)
{
	if (Actor)
	{
...
void UQuaternion_Tilting::SetActorRelativeRotationQuat(AActor* Actor, const FQuat& Desired_Rotation)
{
	if (Actor)
	{
...
void UQuaternion_Tilting::AddActorLocalRotationQuat(AActor* Actor, const FQuat& Delta_Rotation)
{
	if (Actor)
	{
